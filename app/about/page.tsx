  ...
  return (
    <div className="flex flex-col flex-1 bg-wholara-cream text-wholara-green">
      ...
      <main className="flex flex-col flex-1">
        ...
        {/* Story + Credentials band live in a shared relative wrapper so the
            wildflower clusters anchored to the band can rise into the story. */}
    ...
    <section className="relative overflow-hidden bg-wholara-green text-wholara-cream">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-5 py-16 sm:px-8 sm:py-20 md:grid-cols-2 md:gap-14 lg:py-24 lg:gap-16">
        ...
        <div className="relative row-start-1 md:row-start-auto md:justify-self-end">
          <div
            aria-hidden
            className="absolute rounded-2xl border border-wholara-sage"
  ...
  return (
    <section className="relative bg-[#f7f3ec]">
      ...
      <div className="relative mx-auto max-w-2xl px-5 py-20 sm:px-8 sm:py-24 lg:py-28">
        ...
        <p className="font-display mb-10 text-2xl font-medium italic leading-relaxed text-wholara-green sm:text-[1.7rem]">
          People ask me sometimes if I really get what it&apos;s like to feel
          let down by your own body.{" "}
          <span className="font-bold text-wholara-terracotta">I do.</span>{" "}
          I&apos;ve spent most of my life learning exactly how that feels.
        </p>

        <p className="mb-7 text-base leading-relaxed text-wholara-green/85 sm:text-[1.05rem]">
        ...
        <p className="mb-7 text-base leading-relaxed text-wholara-green/85 sm:text-[1.05rem]">
          At 14 I got an ulcerative colitis diagnosis, with a two-week hospital
          stay to go with it. At 17 I was put on hormonal birth control for
          acne and an irregular cycle, and not long after, the panic attacks
          started. They got bad enough that I ended up on Xanax. Then I came
          off the birth control, and they just stopped. That was the first
          time it really hit me that maybe my body was trying to tell me
          something.
        </p>
        ...
        <p className="mb-7 text-base leading-relaxed text-wholara-green/85 sm:text-[1.05rem]">
          ...
          Then came hypothyroidism. A year later, Babesia, a Lyme co-infection,
          and yet another round of treatment.
        </p>
        ...
        <blockquote className="font-display my-12 border-l-[3px] border-wholara-terracotta pl-6 text-2xl italic leading-snug text-wholara-green sm:text-[1.7rem]">
        ...
        <p className="mb-7 text-base leading-relaxed text-wholara-green/85 sm:text-[1.05rem]">
          ...
          of. So I did the one thing still in my control. I went back to school
          and went looking for the answers nobody had been able to give me.
        </p>

        <div className="my-10 flex items-center justify-center gap-4 text-wholara-terracotta">
        ...
        <p className="mb-7 text-base leading-relaxed text-wholara-green/85 sm:text-[1.05rem]">
          And slowly, things turned around. My energy came back, and then some.
          My periods are regular for the first time in my life. My stomach
          finally calmed down. But the change I didn&apos;t see coming was the
          emotional one. I handle stress now in a way I genuinely didn&apos;t
          think I had in me, the sense of humor I&apos;d written off as gone
          is back, and most days my mood is the kind that rubs off on people.
        </p>

        <p className="text-base leading-relaxed text-wholara-green/85 sm:text-[1.05rem]">
          ...
          too. And it gave me the conviction to spend the rest of my career
